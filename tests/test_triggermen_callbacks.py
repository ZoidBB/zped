...
class CallbackClass:
    ...
    def modified_input_echoing_triggerman_pre_exec(args, kwargs):
        raise zped.ModifyPayload([CallbackClass.modified_input_echoing_triggerman_input], kwargs)
    ...
    def modified_output_echoing_triggerman_post_exec(args, kwargs, result):
        raise zped.ModifyPayload([CallbackClass.modified_output_echoing_triggerman_output], kwargs, CallbackClass.modified_output_echoing_triggerman_output)
    ...
    def stopped_triggerman_with_post_exec_pre_exec(args, kwargs):
        raise zped.StopExecution(CallbackClass.stopped_triggerman_with_post_exec_output)
    ...
    def stopped_triggerman_without_post_exec_pre_exec(args, kwargs):
        raise zped.StopExecution(CallbackClass.stopped_triggerman_without_post_exec_output, False)
